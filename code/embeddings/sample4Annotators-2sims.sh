...
cut -f 1-3 < ${prefix}-ket-11_2_4_1_simonly.tsv | head -100 > ${prefix}-ket_11_2_4_1_simonly-4anns.tsv
...
cut -f 1-3 < ${prefix}-ket-11_2_4_1_simidfonly.tsv | head -100 > ${prefix}-ket_11_2_4_1_simidfonly-4anns.tsv
...
cut -f 1-3 < ${prefix}-ket-11_2_4_1_simidfstr.tsv | head -100 > ${prefix}-ket_11_2_4_1_simidfstr-4anns.tsv
...
cut -f 1-3 < ${prefix}-sgc-11_2_4_1_simonly.tsv | head -100 > ${prefix}-sgc_11_2_4_1_simonly-4anns.tsv
...
cut -f 1-3 < ${prefix}-sgc-11_2_4_1_simidfonly.tsv | head -100 > ${prefix}-sgc_11_2_4_1_simidfonly-4anns.tsv
...
cut -f 1-3 < ${prefix}-sgc-11_2_4_1_simidfstr.tsv | head -100 > ${prefix}-sgc_11_2_4_1_simidfstr-4anns.tsv
